(() => {
    var e = {
                ...
                $("[data-gallery-lightbox=true]").magnificPopup({
                    ...
                    image: {
                        titleSrc: function(e) {
                            ...
                            if (i.length) {
                                var a = $("<a></a>");
                                a.attr("href", i), a.attr("target", "_blank"), a.attr("class", "ms-2"), a.html("Download"), t.append(a)
                            }
                            return t.html()
                        }
                    }
            ...
            1424: () => {
                $("a[data-concrete-link-lightbox=image],a[data-concrete5-link-lightbox=image]").each((function() {
                    ...
                    var e = $(this),
                        t = 500,
                        n = 400;
                    $(this).attr("data-concrete-link-lightbox-width") && $(this).attr("data-concrete-link-lightbox-height") ? (t = $(this).attr("data-concrete-link-lightbox-width"), n = $(this).attr("data-concrete-link-lightbox-height")) : $(this).attr("data-concrete5-link-lightbox-width") && $(this).attr("data-concrete5-link-lightbox-height") && (t = $(this).attr("data-concrete5-link-lightbox-width"), n = $(this).attr("data-concrete5-link-lightbox-height")), e.magnificPopup({
                        type: "iframe",
                        callbacks: {
                            beforeOpen: function() {
                                ...
                                $(e.contentContainer).css("maxWidth", t + "px").css("maxHeight", n + "px")
                            }
                        },
                        iframe: {
                            patterns: {
                    ...
                    e.fn.responsiveSlides = function(i) {
                        ...
                        return this.each((function() {
                            ...
                            var o, r, s, l, c, d, u = e(this),
                                ...
                                P = function() {
                                    var e, t = (document.body || document.documentElement).style,
                                        n = "transition";
                                    if ("string" == typeof t[n]) return !0;
                                    for (o = ["Moz", "Webkit", "Khtml", "O", "ms"], n = n.charAt(0).toUpperCase() + n.substr(1), e = 0; e < o.length; e++)
                                        if ("string" == typeof t[o[e] + n]) return !0;
                                    return !1
                                }(),
                                S = function(t) {
                                    a.before(t), P ? (f.removeClass(x).css(T).eq(t).addClass(x).css(_), p = t, setTimeout((function() {
                                        a.after(t)
                                    }), g)) : f.stop().fadeOut(g, (function() {
                            ...
                            if (a.random && (f.sort((function() {
                                ...
                                })), u.empty().append(f)), f.each((function(e) {
                                    this.id = k + e
                                })), u.addClass(C + " " + y), i && i.maxwidth && u.css("max-width", v), f.hide().css(T).eq(0).addClass(x).css(_).show(), P && f.show().css({
                                ...
                                if (a.pager && !a.manualControls) {
                                    ...
                                    f.each((function(e) {
                                        var t = e + 1;
                                        O += "<li><a href='#' class='" + k + t + "'>" + t + "</a></li>"
                                    })), I.append(O), i.navContainer ? e(a.navContainer).append(I) : u.after(I)
                                }
                                if (a.manualControls && (I = e(a.manualControls)).addClass(C + "_tabs " + y + "_tabs"), (a.pager || a.manualControls) && I.find("li").each((function(t) {
                                        e(this).addClass(k + (t + 1))
                                    })), (a.pager || a.manualControls) && (d = I.find("a"), r = function(e) {
                                        ...
                                        l()
                                    })), (a.pager || a.manualControls) && (d.bind("click", (function(t) {
                                        t.preventDefault(), a.pauseControls || l();
                                        var n = d.index(this);
                                        p === n || e("." + x).queue("fx").length || (r(n), S(n))
                                    })).eq(0).closest("li").addClass(w), a.pauseControls && d.hover((function() {
                                        clearInterval(c)
                                    }), (function() {
                                        l()
                                    }))), a.nav) {
                                    var z = "<a href='#' class='" + b + " prev'>" + a.prevText + "</a><a href='#' class='" + b + " next'>" + a.nextText + "</a>";
                                    ...
                                    E.bind("click", (function(t) {
                                        ...
                                        if (!n.queue("fx").length) {
                                            var i = f.index(n),
                                                o = i - 1,
                                                s = i + 1 < m ? p + 1 : 0;
                                            S(e(this)[0] === M[0] ? o : s), (a.pager || a.manualControls) && r(e(this)[0] === M[0] ? o : s), a.pauseControls || l()
                                        }
                                    })), a.pauseControls && E.hover((function() {
                                        clearInterval(c)
                                    }), (function() {
                                        l()
                                    }))
            ...
            101: (e, t, n) => {
                var i, a, o;
                a = [n(1669)], i = function(e) {
                    var t, n, i, a, o, r, s = "Close",
                        l = "BeforeClose",
                        c = "AfterClose",
                        d = "BeforeAppend",
                        u = "MarkupParse",
                    ...
                    y.prototype = {
                        ...
                        open: function(n) {
                            ...
                            if (!t.isOpen) {
                                ...
                                I("BeforeOpen"), t.st.showCloseBtn && (t.st.closeBtnInside ? (x(u, (function(e, t, n, i) {
                                ...
                                }), 16), t.isOpen = !0, t.updateSize(d), I(p), n
                            }
                            t.updateItemHTML()
                        },
                        close: function() {
                        ...
                        updateItemHTML: function() {
                            ...
                            t.appendContent(r, i), n.preloaded = !0, I(f, n), a = n.type, t.container.prepend(t.contentContainer), I("AfterChange")
                        },
                        appendContent: function(e, n) {
                            t.content = e, e ? t.st.showCloseBtn && t.st.closeBtnInside && !0 === t.currTemplate[n] ? t.content.find(".mfp-close").length || t.content.append(_()) : t.content = e : t.content = "", I(d), t.container.addClass("mfp-" + n + "-holder"), t.contentContainer.append(t.content)
                        },
                        parseEl: function(n) {
                            var i, a = t.items[n];
                            if (a.tagName ? a = {
                            ...
                            return a.type = i || t.st.type || "inline", a.index = n, a.parsed = !0, t.items[n] = a, I("ElementParse", a), t.items[n]
                        },
                        ...
                        updateStatus: function(e, i) {
                            if (t.preloader) {
                                ...
                                I("UpdateStatus", a), e = a.status, i = a.text, t.preloader.html(i), t.preloader.find("a").on("click", (function(e) {
                        ...
                        _parseMarkup: function(t, n, i) {
                            var a;
                            i.data && (n = e.extend(i.data, n)), I(u, [t, n, i]), e.each(n, (function(n, i) {
                        ...
                        if ("string" == typeof n)
                            if ("open" === n) {
                                var a, o = b ? i.data("magnificPopup") : i[0].magnificPopup,
                                    r = parseInt(arguments[1], 10) || 0;
                                o.items ? a = o.items[r] : (a = i, o.delegate && (a = a.find(o.delegate)), a = a.eq(r)), t._openClick({
                                    mfpEl: a
                                }, i, o)
                            ...
                            getInline: function(n, i) {
                                if (M(), n.src) {
                                    ...
                                    if (o.length) {
                                        ...
                                        r && r.tagName && (O || (S = a.hiddenClass, O = k(S), S = "mfp-" + S), z = o.after(O).detach().removeClass(S)), t.updateStatus("ready")
                    ...
                    e.magnificPopup.registerModule(F, {
                        ...
                        proto: {
                            initAjax: function() {
                                t.types.push(F), B = t.st.ajax.cursor, x(s + "." + F, L), x("BeforeChange." + F, L)
                            },
                            getAjax: function(n) {
                                ...
                                var i = e.extend({
                                    ...
                                    success: function(i, a, o) {
                                        ...
                                        I("ParseAjax", r), t.appendContent(e(r.data), F), n.finished = !0, H(), t._setFocus(), setTimeout((function() {
                                            t.wrap.addClass(h)
                    ...
                    e.magnificPopup.registerModule("image", {
                        ...
                        proto: {
                            ...
                            findImageSize: function(e) {
                                ...
                                ! function a(o) {
                                    A && clearInterval(A), A = setInterval((function() {
                                        i.naturalWidth > 0 ? t._onImageHasSize(e) : (n > 200 && clearInterval(A), 3 == ++n ? a(10) : 40 === n ? a(50) : 100 === n && a(500))
                                    }), o)
                                }(1)
                            },
                            getImage: function(n, i) {
                                var a = 0,
                                    o = function e() {
                                        n && (n.img[0].complete ? (n.img.off(".mfploader"), n === t.currItem && (t._onImageHasSize(n), t.updateStatus("ready")), n.hasSize = !0, n.loaded = !0, I("ImageLoadComplete")) : ++a < 200 ? setTimeout(e, 100) : r())
                                    },
                                    r = function() {
                    ...
                    e.magnificPopup.registerModule("zoom", {
                        ...
                        proto: {
                                ...
                                if (n.enabled && t.supportsTransition) {
                                    ...
                                    x("BuildControls" + i, (function() {
                                        if (t._allowZoom()) {
                                            ...
                                            (o = c(e)).css(t._getOffset()), t.wrap.append(o), a = setTimeout((function() {
                                                o.css(t._getOffset(!0)), a = setTimeout((function() {
                                                    d(), setTimeout((function() {
                                                        o.remove(), e = o = null, I("ZoomAnimationEnded")
                                                    }), 16)
                                                }), r)
                                            }), 16)
                                        }
                            ...
                            _getOffset: function(n) {
                                ...
                                return W() ? s["-moz-transform"] = s.transform = "translate(" + a.left + "px," + a.top + "px)" : (s.left = a.left, s.top = a.top), s
                            }
                        }
                    });
                    var N = "iframe",
                    ...
                    e.magnificPopup.registerModule(N, {
                        ...
                        proto: {
                            initIframe: function() {
                                t.types.push(N), x("BeforeChange", (function(e, t, n) {
                                    t !== n && (t === N ? D() : n === N && D(!0))
                                })), x(s + "." + N, (function() {
                                    D()
                                }))
                            ...
                            initGallery: function() {
                                ...
                                o += " mfp-gallery", x(p + a, (function() {
                                    ...
                                    if (t.items.length > 1 && n.arrows && !t.arrowLeft) {
                                        var i = n.arrowMarkup,
                                            a = t.arrowLeft = e(i.replace(/%title%/gi, n.tPrev).replace(/%dir%/gi, "left")).addClass(C),
                                            o = t.arrowRight = e(i.replace(/%title%/gi, n.tNext).replace(/%dir%/gi, "right")).addClass(C);
                                        a.click((function() {
                                            t.prev()
                                        })), o.click((function() {
                                            t.next()
            ...
            227: () => {
                ! function(e, a) {
                    document.addEventListener("DOMContentLoaded", (function() {
                        window.innerWidth > 992 ? document.querySelectorAll(".ccm-block-top-navigation-bar .nav-item").forEach((function(e) {
                            e.addEventListener("mouseover", (function(e) {
                                var a = this.querySelector("a[data-concrete-toggle]");
                                if (null != a) {
                                    var t = a.nextElementSibling;
                                    a.classList.add("show"), t.classList.add("show")
                                }
                        ...
                        })) : a("a[data-concrete-toggle]").on("click", (function(e) {
                            a(this).hasClass("show") || (e.preventDefault(), a(this).next().addClass("show"), a(this).addClass("show"))
                        }));
                        var e = a("div[data-transparency=navbar]"),
                            t = a("#ccm-toolbar");
                        if (e.length) {
                            var n = e.find(".navbar");
                            n.hasClass("fixed-top") && t.length > 0 && n.removeClass("fixed-top");
                            var s = e.next();
                            s.length && s.is("[data-transparency=element]") && 0 === t.length && (e.addClass("transparency-enabled"), n.hasClass("fixed-top") && a(window).scroll((function() {
                                a(document).scrollTop() > 5 ? e.removeClass("transparency-enabled") : e.addClass("transparency-enabled")
                            }))), e.show();
                            var r = e.find("[data-bs-toggle]");
                            if (r.length) {
                                var o = a(r.attr("data-bs-target"));
                                o.on("show.bs.collapse", (function() {
                                    e.addClass("transparency-temporarily-disabled")
                                })), o.on("hidden.bs.collapse", (function() {
                                    e.removeClass("transparency-temporarily-disabled")
                                }))
                            }
                        }
                        var l = a(".ccm-block-top-navigation-bar .navbar");
                        l.hasClass("fixed-top") && (0 !== e.length && e.hasClass("transparency-enabled") || a(".ccm-page").css("padding-top", l.outerHeight()))
                    }))
                }(window, $)
            }
        },
