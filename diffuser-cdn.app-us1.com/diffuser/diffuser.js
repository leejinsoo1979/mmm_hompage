            ...
            return function diffuser_createClass(e, t, r) {
                ...
                value: function _executeSetAccount(e) {
                    var t = window.location.href,
                        r = this._visitors[e];
                    r && r._url === t || (this._visitors[e] = new p(e), r && !this._visitors[e]._referrer && (this._visitors[e]._referrer = r._url)), this._accountId = e
                }
            }, {
                ...
                value: function _makeRequestToDiffuser(e, t) {
                    var r, o = (diffuser_defineProperty(r = {}, _, e.accountId), diffuser_defineProperty(r, d, e.email), diffuser_defineProperty(r, b, n.getQueryParam("vgo_ee")), diffuser_defineProperty(r, h, e.url), diffuser_defineProperty(r, y, e.referrer), diffuser_defineProperty(r, v, getDiffuserCookie(e.accountId)), r);
                    this._removeQueryParam(e.siteAllowParameter), this._checkQueryParam(e.accountId) && "" === o[b] && (o[b] = atob(getTempEeCookie()));
